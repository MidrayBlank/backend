...
type Rosstat struct {
	...
	PopulationAmount    *int     `gorm:"column:population_amout;type:int;nullable"`
	...
	LandArea            *int     `gorm:"column:land_area;type:int;nullable"`
	...
	HousingCommissioned *int     `gorm:"column:housing_commissioned;type:int;nullable"`
}
...
func (modelObj *Rosstat) ToModel(domainObj *domain.Rosstat) (*Rosstat, error) {
	return ToModel[Rosstat, domain.Rosstat](domainObj)
}
